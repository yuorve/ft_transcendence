import {
  EffectWrapper
} from "./chunk-DDADECSG.js";
import {
  PostProcessManager,
  RenderingManager,
  SmartArray
} from "./chunk-7P5LPUWD.js";
import {
  PerfCounter
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-WV3SLOF2.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-BRWIEUP2.js");
    const textures = [];
...
//# sourceMappingURL=chunk-YYGC5XCA.js.map
