...
import { ComputedRef, Ref, MaybeRef } from 'vue';
...
declare function useAuth(auth: Auth): {
    ...
    user: Ref<{
        ...
        getIdTokenResult: (forceRefresh?: boolean) => Promise<_firebase_auth.IdTokenResult>;
        reload: () => Promise<void>;
        toJSON: () => object;
        readonly displayName: string | null;
        readonly email: string | null;
 ...
 */
declare function useRTDB<T = any>(docRef: DatabaseReference, options?: UseRTDBOptions): Ref<T | undefined, T | undefined>;
