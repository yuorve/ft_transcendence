<template>
  <div class="justify-items-center bg-amber-300 text-center">
    ...
    <p><router-link :to="{ name: 'PongOnline', params: { game: 'new' } }">Nueva Partida de Pong en Línea</router-link></p>
  </div>
  <div class="bg-gray-300 flex items-center justify-center">
    <div class="container mx-auto p-4">
      ...
      <tbody>
        ...
        <td v-if="player.username !== username" class="border px-4 py-2">{{ player.username }} - 
          ...
          <span v-else><router-link :to="{ name: 'Chats', params: { buddy: player.username } }">Invitar</router-link></span>
        </td>
        </tr>
      </tbody>
      </table>
    ...
    <div class="container mx-auto p-4">
      ...
      <tbody>
        ...
        <td class="border px-4 py-2" v-if="!game.player1 || !game.player2"><router-link :to="{ name: 'PongOnline', params: { game: game.id } }">Unirse</router-link></td>
        </tr>
      </tbody>
      </table>
    </div>
