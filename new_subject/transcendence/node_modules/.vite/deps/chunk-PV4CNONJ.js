import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-RBNC3A2H.js";
import {
  PerfCounter
} from "./chunk-D5BQRY5G.js";
import {
  BaseTexture,
  SerializationHelper,
  Texture
} from "./chunk-MSGEGZZ3.js";
import {
  Color3,
  __decorate,
  serialize,
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-RHXMOBVB.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-4WKBS5AI.js");
    const textures = [];
...
//# sourceMappingURL=chunk-PV4CNONJ.js.map
