import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-YX5H6W3S.js";
import {
  PerfCounter
} from "./chunk-4JRZ7L45.js";
import {
  BaseTexture,
  SerializationHelper,
  Texture
} from "./chunk-S6SFO43F.js";
import {
  Color3,
  __decorate,
  serialize,
...
} from "./chunk-S72UTFPI.js";
import {
  EffectWrapper
} from "./chunk-K2EMLLO3.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-HI76I54V.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-GSRJIARL.js");
    const textures = [];
...
//# sourceMappingURL=chunk-R74UR4MK.js.map
