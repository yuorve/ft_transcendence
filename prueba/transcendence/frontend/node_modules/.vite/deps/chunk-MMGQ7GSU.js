import {
  ...
  PostProcess,
  SphericalPolynomial
} from "./chunk-T4CC24A3.js";
import {
  DumpDataAsync
} from "./chunk-MNJECAK6.js";
import {
  Scene
} from "./chunk-CSX2N2JL.js";
import {
  BaseTexture
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-RCVOP2K6.js");
      } else {
        await import("./rgbdDecode.fragment-MFSEWID6.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-553PKPOX.js");
    } else {
      await import("./rgbdEncode.fragment-HVJ7KJ32.js");
    }
...
//# sourceMappingURL=chunk-MMGQ7GSU.js.map
