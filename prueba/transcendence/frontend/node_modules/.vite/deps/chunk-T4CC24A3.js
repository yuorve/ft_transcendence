import {
  EffectWrapper
} from "./chunk-F44EILPV.js";
import {
  PostProcessManager,
  RenderingManager,
  SmartArray
} from "./chunk-ARYRB4SI.js";
import {
  PerfCounter
} from "./chunk-BSIQKGBL.js";
import {
  BaseTexture,
  SerializationHelper,
  Texture
} from "./chunk-GIJM6WFH.js";
import {
  Color3,
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-RS4BC5R4.js";
import {
  Matrix,
  TmpVectors,
  ToLinearSpace,
  ...
  Vector3,
  _ObserveArray
} from "./chunk-DIBBIPTF.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-SBZBENTR.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-RPMTIRLH.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-NYGK242N.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-GL4CBSW3.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-VFK7RI7O.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-E5NTM6JV.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-XH4WUTST.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-HIWZGGUK.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-TCIO6XFV.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-GZJIZYOM.js");
    } else {
      await import("./lod.fragment-PR2BIZM7.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-GEDVGL7W.js");
    } else {
      await import("./lod.fragment-TN7DUS7S.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-T4CC24A3.js.map
