import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-MDGI7O5T.js";
import {
  PerfCounter
} from "./chunk-Z7MOTK3L.js";
import {
  BaseTexture,
  SerializationHelper,
  Texture
} from "./chunk-AZGJOJ2O.js";
import {
  Color3,
  __decorate,
  serialize,
...
} from "./chunk-LNYSBCJA.js";
import {
  EffectWrapper
} from "./chunk-UT4DPLLV.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-KWCKVHHY.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-HQLW6MK6.js");
    const textures = [];
...
//# sourceMappingURL=chunk-P6RTBYSU.js.map
